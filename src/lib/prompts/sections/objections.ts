...
"Totally get it — is it more that life is genuinely slammed right now, or is it more that you want to make sure this is the right fit before committing time to a call?"
...
"Makes sense to think about that. Are you in a spot where you have some saved up but it doesn't feel like enough, or is it more that you're starting from zero right now?"
...
"Small markets can actually be a real advantage — there's less competition and easier to lock down premium spots. Where exactly are you? I might be able to speak to that area specifically."
