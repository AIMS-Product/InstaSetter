 ...
 * - Explicit confirmation loop ("Got it — I'll send to [email]") validates data
 */
...
"Got it — I'll send your pre-call resources to [email] as soon as we lock in the time. Check your spam folder if you don't see it within a few minutes."
