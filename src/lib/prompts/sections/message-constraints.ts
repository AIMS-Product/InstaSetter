...
export function buildMessageConstraints(
...
- GOOD: "Sounds good, here's the link to grab a time: ${bookingUrl}. Let me know once you've locked one in and I'll confirm things on my end."
